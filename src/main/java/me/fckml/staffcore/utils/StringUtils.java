...
public class StringUtils {
    ...
    public static String formatDurationWords(long durationMillis, boolean suppressLeadingZeroElements, boolean suppressTrailingZeroElements) {
        ...
        if (suppressLeadingZeroElements) {
            duration = " " + duration;
            tmp = org.apache.commons.lang.StringUtils.replaceOnce(duration, " 0 days", "");
            if (tmp.length() != duration.length()) {
                duration = tmp;
                tmp = org.apache.commons.lang.StringUtils.replaceOnce(tmp, " 0 hours", "");
                if (tmp.length() != duration.length()) {
                    tmp = org.apache.commons.lang.StringUtils.replaceOnce(tmp, " 0 minutes", "");
                    duration = tmp;
        ...
        if (suppressTrailingZeroElements) {
            tmp = org.apache.commons.lang.StringUtils.replaceOnce(duration, " 0 seconds", "");
            if (tmp.length() != duration.length()) {
                duration = tmp;
                tmp = org.apache.commons.lang.StringUtils.replaceOnce(tmp, " 0 minutes", "");
                if (tmp.length() != duration.length()) {
