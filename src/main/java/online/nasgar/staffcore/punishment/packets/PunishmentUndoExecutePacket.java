...
@Data
public class PunishmentUndoExecutePacket implements Packet {
    ...
    @Override
    public String id() {
        return "PUNISHMENT_UNDO_EXECUTE";
    }
    ...
    public PunishmentUndoExecutePacket() {}

    public PunishmentUndoExecutePacket(Punishment punishment, String victimName, String staffName) {
